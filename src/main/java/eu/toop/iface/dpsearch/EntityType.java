...
package eu.toop.iface.dpsearch;
 ...
 *         &lt;element name="identifier" type="{}IDType" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class EntityType {
    ...
    protected List<IDType> identifier;
    ...
    public List<IDType> getIdentifier() {
        if (identifier == null) {
            identifier = new ArrayList<IDType>();
        }
